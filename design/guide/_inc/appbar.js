...
(function () {
  ...
  STYLE.textContent = [
    ...
    '.search-results { display: none; position: absolute; top: 100%; right: 0; min-width: 320px; margin-top: var(--space-1); background: var(--bg-elevated); border: 1px solid var(--border-default); border-radius: var(--radius-lg); box-shadow: var(--shadow-lg); max-height: 400px; overflow-y: auto; z-index: 200; }',
    '@media (min-width: 768px) { .search-results { left: 0; min-width: auto; } }',
